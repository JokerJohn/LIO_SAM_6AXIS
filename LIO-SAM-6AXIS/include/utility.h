...
class ParamServer {
 public:
  ...
  ParamServer() {
    ...
    nh.param<std::string>("lio_sam_6axis/scene_name", scene_name, "map");
...
//    std::cout << "qw:" << extQRPY << std::endl;
    ...
    nh.param<float>("lio_sam_6axis/surroundingkeyframeAddingDistThreshold", surroundingkeyframeAddingDistThreshold, 1.0);
    nh.param<float>("lio_sam_6axis/surroundingkeyframeAddingAngleThreshold", surroundingkeyframeAddingAngleThreshold, 0.2);
